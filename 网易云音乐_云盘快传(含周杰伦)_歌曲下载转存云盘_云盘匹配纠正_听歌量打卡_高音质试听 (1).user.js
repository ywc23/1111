...
-----END PUBLIC KEY-----`;
  ...
  const scrobble = (uiArea) => {
    ...
    function listenDaily() {
      let begin = Math.floor((/* @__PURE__ */ new Date()).getTime() / 1e3);
      let logs = [];
        ...
        weapiRequest("/api/v1/cloud/get", {
          ...
          onload: (res) => {
            ...
            res.data.forEach((song) => {
              ...
              levelWeight[song.simpleSong.privilege.playMaxBrLevel];
